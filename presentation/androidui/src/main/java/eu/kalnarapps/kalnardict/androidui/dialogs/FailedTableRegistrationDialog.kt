...
class FailedTableRegistrationDialog : DialogFragment() {

    private val args: FailedTableRegistrationDialogArgs by navArgs()
    ...
    private fun View.setUpView() {
        ...
        titleView.text =
            getString(R.string.table_registration_dialog_error_title, args.originalTableName)
        descriptionView.text =
            getString(R.string.table_registration_dialog_error_description, args.errorMessage)
        button.setOnClickListener {
            this@FailedTableRegistrationDialog.dismiss()
        }
    }
}
