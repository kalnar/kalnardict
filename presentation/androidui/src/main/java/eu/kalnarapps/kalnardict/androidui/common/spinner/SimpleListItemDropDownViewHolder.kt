...
class SimpleListItemDropDownViewHolder(
    inflater: LayoutInflater, parent: ViewGroup?
) : RecyclerView.ViewHolder(
    inflater.inflate(
        R.layout.simple_list_item_drop_down_view,
        parent,
        false
    )
) {
    private val displayTitle: TextView = itemView.findViewById(R.id.simple_list_item_drop_down)
